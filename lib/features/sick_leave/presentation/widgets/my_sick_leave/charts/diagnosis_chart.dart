...
class DiagnosisChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double maxY = dataList.isEmpty
        ? 0
        : dataList.map((d) => (d.count ?? 0).toDouble()).reduce(math.max) + 1;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Top 5 Diagnosis by Monthly Requests',
                  ...
                  BarChartData(
                            ...
                            if (value.toInt() >= 0 && value.toInt() < dataList.length) {
                              return SideTitleWidget(
                                ...
                                child: Transform.rotate(
                                  angle: -0.5,
                                  child: Text(
                                    dataList[value.toInt()].diagnosisName ?? '',
                    ...
                    barGroups: dataList.asMap().entries.map((entry) {
                      ...
                      return BarChartGroupData(
                        ...
                        barRods: [
                          BarChartRodData(
                            toY: ((item.count ?? 0).toDouble() * animation.value),
                            color: Color.lerp(
                              const Color(0xFFF08040),
