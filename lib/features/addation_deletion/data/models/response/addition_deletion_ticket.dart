class AdditionDeletionTicket {
  ...
  AdditionDeletionTicket copyWith({
    List<AdditionDeletionTicketModel>? result,
    num? returnedTicketsCount,
    num? totalCount,
    num? totalPages,
...
class AdditionDeletionTicketModel {
  ...
  AdditionDeletionTicketModel.fromJson(dynamic json) {
    ...
    policyIds = json['policy_ids'] != null
        ...
        : [];
    policyNames = json['policy_names'] != null
        ? json['policy_names'].cast<String>()
        : [];
  ...
  AdditionDeletionTicketModel copyWith({
    String? additionDeletionTriggered,
    List<ConfirmedMembers>? confirmedMembers,
    num? confirmedMembersCount,
    String? createDate,
    ...
    additionDeletionTriggered:
        additionDeletionTriggered ?? this.additionDeletionTriggered,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (confirmedMembers != null) {
      map['confirmed_members'] = confirmedMembers
          ?.map((v) => v.toJson())
          .toList();
    }
...
class ConfirmedMembers {
  ...
  ConfirmedMembers.fromJson(dynamic json) {
    ...
    branchId = json['branch_id'] is num ? json['branch_id'] : num.tryParse(json['branch_id'] ?? '');
